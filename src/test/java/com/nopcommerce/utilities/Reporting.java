...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter = new ExtentHtmlReporter("A:/Java Project/nopCommerceV2/test-output" + repName);// specify
																										// location
																										// of the
																										// report
		htmlReporter.loadXMLConfig("A:/Java Project/nopCommerceV2/extent-config.xml");
