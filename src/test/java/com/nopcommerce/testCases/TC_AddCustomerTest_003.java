...
public class TC_AddCustomerTest_003 extends BaseClass {
	...
	public void addNewCustomer() throws IOException, InterruptedException {
		...
		addcust.setFirstName("Hardik");
		addcust.setLastName("Dhokiya");

		logger.info("Providing dob");
		addcust.setDob("21/11/1997"); // Format: D/MM/YYY
		...
		// String
		// msg=driver.findElement(By.xpath("/html/body/div[3]/div[3]/div[1]")).getText();
